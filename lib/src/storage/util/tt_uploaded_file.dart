...
class TTUploadedFile {
  const TTUploadedFile({
    this.name,
    this.bytes,
    this.height,
    this.width,
  ...
  @override
  String toString() =>
      'TTUploadedFile(name: $name, bytes: ${bytes?.length ?? 0}, height: $height, width: $width, blurHash: $blurHash,)';
  ...
  static TTUploadedFile deserialize(String val) {
