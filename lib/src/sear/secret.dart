...
Future<dynamic> secret(String key, PairReturnType pair,
  ...
  final props = await crypto.EcdhPublicKey.importJsonWebKey(
      pubKeyData.toJson(), crypto.EllipticCurve.p256);

  final privKeyData = jwk(epub, epriv);

  final privKey = await crypto.EcdhPrivateKey.importJsonWebKey(
      privKeyData.toJson(), crypto.EllipticCurve.p256);
