...
class InfusionCryptoAdapter implements TTCryptoPort {
  ...
  InfusionCryptoAdapter({InfusionFFI? infusion}) : _infusion = infusion;
  ...
  Future<void> init(String aead, String sig) async {
    ...
    _infusion = await InfusionFFI.create(encKeyHex: aead, signSeedHex: sig);
  }
  ...
  Future<int> getBlindScale(String assetType) async {
    ...
    throw UnimplementedError(
      'Blind scale logic moved to specific UseCase or requires FbblApi',
    );
  }
